	...
	<div id="about" class="container spacer about">
		...
		<div class="row">
			<div class="col-sm-6 wowload fadeInLeft">
				...
				<p align="justify">O projeto InformaCão surgiu do esforço conjunto de professores do curso de 
				Medicina Veterinária, preocupados com o crescente números de cães abandonados 
				e os problemas sociais e de saúde pública ocasionados desse fato. Ambicionavam 
				ainda, um modo de transmitir as comunidades informações e dicas de cuidados 
				gerais para com seu animal de estimação, com enfoque especial em doenças 
				parasitárias, principalmente zoonoses (doenças naturalmente transmissíveis do 
				animal ao homem), além é claro, da posse responsável de animais domésticos.
				Para isso reuniram um grupo de alunos, previamente selecionados, 
				do curso de Medicina Veterinária, liderados e treinados por professores 
			...
			<div class="col-sm-6 wowload fadeInRight">
				...
				<p align="justify">Desse modo o projeto atuará 
				em parceria com as comunidades visando sensibilizar seus membros quanto 
				à posse responsável de animais domésticos, cuidados com sua saúde, evidenciando 
				o grande problema causado pelo abandono desses animais.
				A importância no cuidado e tratamento de doenças que a maioria da população tem pouco 
				conhecimento do assunto, é também um dos principais objetivos do projeto, que buscará 
				desse modo contribuir de forma efetiva, não apenas com o bem-estar animal, 
				mas também com a saúde e bem-estar das comunidades.</p>
				</br>
				<h4>
