        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($uploaded_file && is_uploaded_file($uploaded_file)) {
                ...
                if ($append_file) {
					...
					//redimensionar($largura, $altura, $tipo, $destino);
					
					if (!move_uploaded_file($uploaded_file, $file_path)){
							return "Não foi possivel enviar o arquivo";
					}else{
						$this->redimensionar(1000, 100, $tipo, $$file_path); //Inbdependente do tamanho da imagem ele irá redimensionar seja para mais ou para menos
					}
