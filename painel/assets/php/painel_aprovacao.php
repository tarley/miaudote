<?php
	...
	function lista_aprovacao($argumento,$id_ong,$id_animal){ // Esta funcão retorna retorna os animaos cadsatrados no sistema. Podendo ser por usuario ou por id do animal e por usuario.
						...
						<div class='panel panel-default'>
							...
							<div id='collapse<?php echo $cod_animal ?>' class='panel-collapse collapse'>
								...
								<div class='panel-body' id='panel-foot-body'>
									<div class='row'>
										<div class='col-md-5'>
											<a href='#'  id="reprovarAnimal"data-animal ="<?php echo $cod_animal?>"data-usuario="<?php echo $cod_usuario?>">
											  <span type="button" class="btn btn-danger">Reprovar</span>
											</a>
										</div>
										<div class='col-md-3'>
											<a href='#' id='aprovarAnimal' data-animal =<?php echo $cod_animal?> data-usuario =<?php echo $cod_usuario?>>
