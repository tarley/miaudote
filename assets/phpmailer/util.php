...
function enviaEmail($nomeRemetente,$emailRemetente,$msg){
	...
	$mail->SMTPAuth = true;
	$mail->CharSet = "UTF-8";
	$mail->Username = "salve1pet@gmail.com";
	$mail->Password = "salve@pet123";
	$mail->setFrom('salve1pet@gmail.com','Salve um pet');
	$mail->addAddress('marcelasilvagomes@hotmail.com', 'Salve Um Pet');
	$mail->Subject = 'Contato direto do site';
	$mail->isHtml(true);
